...
const ProductCard = ({} : IProps) => {
  return (
    <div className="border rounded-md p-4 text-slate-200 flex flex-col">
      ...
      <img src="https://images3.alphacoders.com/133/1335169.png" alt="product" />
      ...
      <div className="flex items-center justify-between text-black">
        <span >$500,000</span>
        <img className="w-10 h-10 rounded-full" src="https://images3.alphacoders.com/133/1335169.png" alt="product" />
      </div>


      <div className="text-black flex justify-between space-x-2 mt-5">
